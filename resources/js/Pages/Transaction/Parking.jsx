        ...
        },
        {
            ...
            cell: ({ row }) => {
                ...
                const { data, setData, patch } = useForm({
                    date: parking.date,
                    vehicleType_id: parking.vehicleType_id,
                    count: parking.count,
                    isCustomFee: parking.isCustomFee,
                    fee: parking.fee,
                ...
                const handleEdit = (event) => {
                    event.preventDefault();
                    try {
                        patch(`/transaksi/parkir/${parking.id}`);
                ...
                const handleDelete = () => {
                    router.post(`/transaksi/parkir/${parking.id}/delete`, {
                        _method: "delete",
                    });
                };
